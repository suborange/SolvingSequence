...
//DOM
/// canvas top left
const canvastl = document.querySelector('#canvastl');
...
function setup() {
    ...
    let canvas = createCanvas(450, 291, WEBGL);
...
function draw() {
    ...
    background(34,49,78); // #22314E
    // camera controls for free rotation
    orbitControl(1.5, 1.5, 1, { freeRotation: true }); //ez pz
